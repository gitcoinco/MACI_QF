...
export interface MessageProcessorFactoryInterface extends Interface {
  getFunction(
...
export interface MessageProcessorFactory extends BaseContract {
  connect(runner?: ContractRunner | null): MessageProcessorFactory;
