...
export interface AccQueueBinary0Interface extends Interface {
  getFunction(
    nameOrSignature:
      | "MAX_DEPTH"
      | "calcMinHeight"
...
export interface AccQueueBinary0 extends BaseContract {
  connect(runner?: ContractRunner | null): AccQueueBinary0;
  waitForDeployment(): Promise<this>;

  interface: AccQueueBinary0Interface;
