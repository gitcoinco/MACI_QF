...
export interface AccQueueBinaryMaciInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "MAX_DEPTH"
      | "calcMinHeight"
...
export interface AccQueueBinaryMaci extends BaseContract {
  connect(runner?: ContractRunner | null): AccQueueBinaryMaci;
  waitForDeployment(): Promise<this>;

  interface: AccQueueBinaryMaciInterface;
