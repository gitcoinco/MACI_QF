...
export interface AccQueueQuinary0Interface extends Interface {
  getFunction(
    nameOrSignature:
      | "MAX_DEPTH"
      | "calcMinHeight"
...
export interface AccQueueQuinary0 extends BaseContract {
  connect(runner?: ContractRunner | null): AccQueueQuinary0;
  waitForDeployment(): Promise<this>;

  interface: AccQueueQuinary0Interface;
