...
export interface AccQueueQuinaryMaciInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "MAX_DEPTH"
      | "calcMinHeight"
...
export interface AccQueueQuinaryMaci extends BaseContract {
  connect(runner?: ContractRunner | null): AccQueueQuinaryMaci;
  waitForDeployment(): Promise<this>;

  interface: AccQueueQuinaryMaciInterface;
